  ...
  <div class="home">
    ...
    <section class="hero">
        <div class="hero__content">
            <h1 class="hero__heading">Create Course Off-Canvas Navigation<br>w/Page Transitions</h1>
...
import DashbaordTeacher from '@/components/DashboardTeacher.vue'; // @ is an alias to /src
